...
public:
  ...
  virtual void Configure(XMLElementEx* element, CDPComponent* owner, ServerIO::ChannelManager* channelManager);

  virtual void Initialize(I2CAdapter& adapter);
  virtual void Process(I2CAdapter& adapter);
